...
public class Info_Fragment extends Fragment implements View.OnClickListener{
	...
	private LinearLayout ll_main,ll_seprator,ll_contact_us,ll_share_app,ll_rate_this_app,ll_more_app;
	private LinearLayout ll_visit_our_website,ll_like_us_on_facebook,ll_follow_us_on_instagram,ll_follow_us_on_twitter;
	private TextView txt_app_name,txt_info,txt_app_version,txt_privacy,txt_terms_condition;
	private CardView crd_info,crd_social;
	private AppCompatImageView icon_contact_us, icon_share_app, icon_rate_this_app, icon_more_app,icon_visit_our_website;
	private AppCompatImageView icon_follow_us_on_twitter, icon_follow_us_on_instagram, icon_like_us_on_facebook;
	private AppCompatTextView txt_contact_us, txt_share_app, txt_rate_this_app, txt_more_app;
	private AppCompatTextView txt_follow_us_on_twitter, txt_follow_us_on_instagram, txt_like_us_on_facebook, txt_visit_our_website;
	private AppCompatImageView arrow_contact_us, arrow_share_app, arrow_rate_this_app, arrow_more_app;
	private AppCompatImageView arrow_follow_us_on_twitter, arrow_follow_us_on_instagram, arrow_like_us_on_facebook, arrow_visit_our_website;
	...
	public void onCreate(@Nullable Bundle savedInstanceState)
	{
		...
		try
		{
			...
			if(bundle!=null) //getting bundle data and set value
			{
				...
				INL_Constant_Data.colorCode_Header = bundle.getInt(INL_Constant_Data.Header_BG_Color);
				INL_Constant_Data.BG_ColorCode_Info_Screen = bundle.getInt(INL_Constant_Data.InfoScreen_BG_Color);
				INL_Constant_Data.colorCode_header_Text = bundle.getInt(INL_Constant_Data.Header_Text_Color);
				INL_Constant_Data.colorCode_Text = bundle.getInt(INL_Constant_Data.Text_Color);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		txt_info.setTextColor(INL_Constant_Data.colorCode_Text);
		txt_app_name.setTextColor(INL_Constant_Data.colorCode_Text);
		txt_app_version.setTextColor(INL_Constant_Data.colorCode_Text);
	...
	private void init(View view) // initialization of widgets
	{
		...
		icon_contact_us=view.findViewById(R.id.icon_contact_us);
		icon_share_app=view.findViewById(R.id.icon_share_app);
		icon_rate_this_app=view.findViewById(R.id.icon_rate_this_app);
		icon_more_app=view.findViewById(R.id.icon_more_app);
		icon_follow_us_on_twitter=view.findViewById(R.id.icon_follow_us_on_twitter);
		icon_follow_us_on_instagram=view.findViewById(R.id.icon_follow_us_on_instagram);
		icon_like_us_on_facebook=view.findViewById(R.id.icon_like_us_on_facebook);
		icon_visit_our_website=view.findViewById(R.id.icon_visit_our_website);

		txt_contact_us=view.findViewById(R.id.txt_contact_us);
		txt_share_app=view.findViewById(R.id.txt_share_app);
		txt_rate_this_app=view.findViewById(R.id.txt_rate_this_app);
		txt_more_app=view.findViewById(R.id.txt_more_app);
		txt_follow_us_on_twitter=view.findViewById(R.id.txt_follow_us_on_twitter);
		txt_follow_us_on_instagram=view.findViewById(R.id.txt_follow_us_on_instagram);
		txt_like_us_on_facebook=view.findViewById(R.id.txt_like_us_on_facebook);
		txt_visit_our_website=view.findViewById(R.id.txt_visit_our_website);

		arrow_contact_us=view.findViewById(R.id.arrow_contact_us);
		arrow_share_app=view.findViewById(R.id.arrow_share_app);
		arrow_rate_this_app=view.findViewById(R.id.arrow_rate_this_app);
		arrow_more_app=view.findViewById(R.id.arrow_more_app);
		arrow_follow_us_on_twitter=view.findViewById(R.id.arrow_follow_us_on_twitter);
		arrow_follow_us_on_instagram=view.findViewById(R.id.arrow_follow_us_on_instagram);
		arrow_like_us_on_facebook=view.findViewById(R.id.arrow_like_us_on_facebook);
		arrow_visit_our_website=view.findViewById(R.id.arrow_visit_our_website);

		crd_info=view.findViewById(R.id.crd_info);
		crd_social=view.findViewById(R.id.crd_social);
	...
	private void manageOnClick() //set ClickListener
	{
		...
		txt_app_name.setText(INL_Constant_Data.str_app_name);
